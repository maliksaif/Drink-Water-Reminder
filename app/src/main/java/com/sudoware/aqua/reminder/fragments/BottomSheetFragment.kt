package com.sudoware.aqua.reminder.fragments
...
class BottomSheetFragment(private val mCtx: Context) : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        sharedPref = activity!!.getSharedPreferences(AppUtils.USERS_SHARED_PREF, AppUtils.PRIVATE_MODE)
        ...
        return if(!isThemeDark)
            ...
            inflater.inflate(R.layout.bottom_sheet_fragment_dark, container, false)
